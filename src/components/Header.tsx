...
const Header = () => {
      ...
      <div className="logo">
        <Link to="/">
          <div className="logo-cont">
            <img src={LogoUrl} alt="Red Dune Logo" />
          </div>
        </Link>
      </div>
          ...
          {showMobileMenu && (
            <div className="dropdown-menu mobile-menu">
              <div className="menu-section">
                ...
                {isAuthenticated ? (
                  <>
                    <Link to="/customer/account" onClick={() => setShowMobileMenu(false)}>
                      <FaRegUser /> Account
                    </Link>
                    <Link to="/customer/orders" onClick={() => setShowMobileMenu(false)}>
                      <LuPackage /> Orders
                    </Link>
                    <Link to="/customer/wishlist" onClick={() => setShowMobileMenu(false)}>
                      <FaHeart /> Wishlist
                    </Link>
  ...
  return (
    <header className="header">
      {windowWidth <= 768 ? minimizedHeader : standardHeader}
    </header>
  );
};
